...
#     # eta_measured = np.load(f'data/3 post/eta{i}_measured_new.npy')
...
#     # ps_mesh.add_scalar_quantity(f"mask{i}", mask, defined_on="faces", enabled=True, cmap="twilight")
#     # ps_mesh.add_scalar_quantity(f"eta{i}", eta, defined_on="faces", enabled=True, cmap="twilight")
