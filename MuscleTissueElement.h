...
// public:
//   /**
//    * Constructor for the MuscleTissueElement class
...
//    */
//   double energy(const Eigen::Ref<const Eigen::VectorXd> X, double mu) const;

//   /**
//    * @param X  a flat vector stacking all degrees of freedom
//    * @return  gradient of the energy (9 by 1 vector), derivatives are stacked in the order of the triangle indices
//    */
//   fsim::Vec<double,6> gradient(const Eigen::Ref<const Eigen::VectorXd> X, double mu) const;
...
//    */
//   fsim::Mat<double, 6, 6> hessian(const Eigen::Ref<const Eigen::VectorXd> X, double mu) const;
...
//    */
//   Eigen::Matrix2d stress(double mu) const;
...
public:
   ...
   * @return second Piola-Kirchhoff stress
   */
  Eigen::Matrix2d stress(const Eigen::Ref<const Eigen::VectorXd> X, double lambda, double mu, double stretch, double sigma) const;
  Eigen::Matrix3d elasticityTensor(const Eigen::Ref<const Eigen::VectorXd> X, double lambda, double mu, double stretch, double sigma) const;
