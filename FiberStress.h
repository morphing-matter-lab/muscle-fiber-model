...
Eigen::MatrixXd fiber_stress(const Eigen::MatrixXd& V, const Eigen::MatrixXd& P, const Eigen::MatrixXd& F, int nb_directions, double e0, double e1);
...
Eigen::MatrixXd polymer_fraction_reduced(const Eigen::MatrixXd &stress, double kf, double kd, double frac_f, double frac_s);
